  ...
  return(
    ...
    <div className="flex w-full w-6/12" style={{ position: 'absolute', top: '10px', justifyContent: 'space-around'}}>
      <div class="flex">
        ...
        <button className="p-4 rounded-lg gray-700 bg-yellow-400 hover:bg-yellow-600 btn btn-small border-solid text-black " onClick={props.openModal}>Show Dashboard</button>
      </div>
    </nav>
  )
}
